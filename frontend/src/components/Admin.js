        ...
        <ul class="space-y-2 font-medium">
           ...
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="/admin/listproperty" class="flex-1 ms-3 whitespace-nowrap">List property</Link>
           ...
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="/update" class="flex-1 ms-3 whitespace-nowrap">Modify property</Link>
           ...
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link path="/admin/DeleteProperty" class="flex-1 ms-3 whitespace-nowrap">Delete property</Link>
              </a>
           </li>
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
