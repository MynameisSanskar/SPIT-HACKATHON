        ...
        <ul class="space-y-2 font-medium">
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="dashboard" class="ms-3">Dashboard</Link>
              </a>
           </li>
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="listproperty" class="flex-1 ms-3 whitespace-nowrap">List Product</Link>
           ...
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="update" class="flex-1 ms-3 whitespace-nowrap">Modify Product</Link>
           ...
           <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="delete" class="flex-1 ms-3 whitespace-nowrap">Delete Product</Link>
           ...
           <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <Link to="analysis" class="flex-1 ms-3 whitespace-nowrap">Product Analysis</Link>
