...
import AboutLottie from "../../lotties/about.js";
    ...
    <div style={{ backgroundImage: `url(${bg})`, backgroundSize: "cover" }}>
      <div class=" w-fitbg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <section class="bg-white dark:bg-gray-900">
          <div
            class="grid max-w-screen-xl px-4 py-8 mx-10 lg:gap-8 xl:gap-0  lg:grid-cols-12"
            style={{ margin: "25px" }}
          >
      ...
      {isVisible && (
        <section class=" bg-teal-300 dark:bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 bg-teal-300 ">
